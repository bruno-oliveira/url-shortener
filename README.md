...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-e1xgnp0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-e1xgnp0.containers.anotherwebservice.com/
...
```
git clone git@github.com:bruno-oliveira/url-shortener.git
cd container-e1xgnp0
```
...
```
docker attach container-e1xgnp0
```
